...
function Dashboard(){
    ...
    async function addPlayer(id){
      ...
      await axios.put('https://mern-stack-tonid.herokuapp.com/own/' + id, {userId: currentUser.id}).then(res => {
          return res.json();
      });  
    ...
    async function handleUpdate(id){
        await axios.put('https://mern-stack-tonid.herokuapp.com/put/' + id, updatedPlayer).then(res => {
            return res.json();
        });
    ...
    async function deleteItem(id){
       await axios.delete('https://mern-stack-tonid.herokuapp.com/delete/'+id).then(res => {
           return res.json();
       });
